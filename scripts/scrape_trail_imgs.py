...
#     while True:
#         try:
#             load_more_ratings = WebDriverWait(driver, 10).until(EC.visibility_of_element_located((By.XPATH,"//div[@id='load_more'] [@class='feed-item load-more'][//a]")))
...
if __name__ == '__main__':
    # df=pd.read_pickle('../data/alltrails_ontario_curated.pkl')
    # print (df.iloc[0])
    ...
    # soup = BeautifulSoup(driver.page_source, 'lxml')
    # driver.find_element_by_id("mobile-trail-map").get_attribute("src")
    # url = driver.find_element_by_id("mobile-trail-map").get_attribute("src")
    # urllib.urlretrieve(url, "test_trail_img.jpg")
